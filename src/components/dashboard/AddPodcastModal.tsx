...
import { Plus, X, Upload, Music, Video, Mic, Check, AlertTriangle, Shield, RefreshCw, FileText, AlertCircle, ChevronDown, ChevronUp, ExternalLink, Maximize2 } from 'lucide-react';
